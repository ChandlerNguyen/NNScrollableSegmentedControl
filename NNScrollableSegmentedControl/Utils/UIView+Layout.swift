...
extension UIView {
    ...
    @discardableResult
    func heightAnchor(equalTo dimension: NSLayoutDimension, multiplier: CGFloat) -> Self {
        heightAnchor.constraint(equalTo: dimension, multiplier: multiplier).isActive = true
        return self
    }
    
    @discardableResult
    func widthAnchor(equalTo dimension: NSLayoutDimension, multiplier: CGFloat) -> Self {
